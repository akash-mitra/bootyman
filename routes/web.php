...
Route::delete('/snapshots/{snapshot}', 'HomeController@snapshotsSoftDelete')->name('snapshot.softdelete')->middleware('auth');
...
Route::any('/events', 'HomeController@anyData')->name( 'events.datatables.data');
